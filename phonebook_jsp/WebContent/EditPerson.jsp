    ...
    <tr>
        ...
        <%
          for(String phone : person.getPhones().values())
           {
         	out.write(phone);
         	out.write("<a href='http://localhost:8080/phonebook_jsp/?action=editPhone'> Редактировать </a>");
         	out.write("<a href='http://localhost:8080/phonebook_jsp/?action=deletePhone'> Удалить </a>");
         	out.write("<br/>");
           }
         %>
         <a  href="http://localhost:8080/phonebook_jsp/?action=addPhone">Добавить</a>
        </td>
    </tr>
    <tr>
