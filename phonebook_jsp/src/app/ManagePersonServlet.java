...
public class ManagePersonServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher_for_edit_person = request.getRequestDispatcher("/EditPerson.jsp");
		RequestDispatcher dispatcher_for_add_phone = request.getRequestDispatcher("/AddPhone.jsp");
		...
		// Если же действие указано, то...
			...
			case "edit":
				...
				// Передача запроса в JSP.
				dispatcher_for_edit_person.forward(request, response);
				break;
